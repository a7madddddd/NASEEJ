          ...
          <div class="col-xl-4 col-md-6 mb-4">
              ...
              <select onchange="editstatus(${product.serviceId})" id="status-${product.serviceId}" class="admin-only form-select bg-custom text-dark form-select-sm">
                  ...
                  <div class="card-footer text-center">
                      ...
                      <a href="#" class="btn btn-danger" onclick="deleteservices(${product.serviceId})"><i class="fas fa-trash"></i> Delete</a>
                  </div>
              </div>
          </div>
      `;
...
async function addservice() {
  ...
  async function editservice(id) {
      var urll1 = `http://localhost:25025/api/services/getservicesbyid/${id}`;
